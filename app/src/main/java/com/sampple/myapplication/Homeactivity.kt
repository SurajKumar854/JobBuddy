...
import com.sampple.myapplication.databinding.ActivityHomeactivityBinding
...
class Homeactivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val navController = findNavController(R.id.nav_host_fragment_activity_homeactivity)
